...
export const routes: Routes = [
  ...
  {path: 'profiles/9', component: WipComponent, data: {index:9}},
  {path: 'profiles/10', component: WipComponent, data: {index:10}},
  {path: 'profiles/11', component: WipComponent, data: {index:11}},
  {path: 'profiles/12', component: WipComponent, data: {index:12}},
